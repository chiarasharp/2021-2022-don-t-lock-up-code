...
if __name__ == "__main__":
    ...
    if not os.path.exists(path_errors + f"/date_null/{name_column}" + "_journal"):
        os.mkdir(path_errors + f"/date_null/{name_column}" + "_journal")
    if not os.path.exists(path_errors + f"/date_wrong/{name_column}" + "_journal"):
        os.mkdir(path_errors + f"/date_wrong/{name_column}" + "_journal")

    group_self_citation(path_to_dir, path_output + "/tmp", path_errors + f"/date_null/{name_column}" + "_journal",
                        path_errors + f"/date_wrong/{name_column}" + "_journal", name_column)
